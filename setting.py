...
# # 爬虫相关
# # COLLECTOR
COLLECTOR_SLEEP_TIME = 3  # 从任务队列中获取任务到内存队列的间隔
...
# )
SPIDER_TASK_COUNT = 5  # 每个parser从内存队列中获取任务的数量
...
ITEM_FILTER_SETTING = dict(
    filter_type=2  # 永久去重（BloomFilter） = 1 、内存去重（MemoryFilter） = 2、 临时去重（ExpireFilter）= 3
)
...
# DINGDING_WARNING_PHONE = "ip报警机器人"  # 报警人 支持列表，可指定多个
# DINGDING_WARNING_ALL = True  # 是否提示所有人， 默认为False
# # 邮件报警
# EMAIL_SENDER = ""  # 发件人
# EMAIL_PASSWORD = ""  # 授权码
...
# # 时间间隔
WARNING_INTERVAL = 30  # 相同报警的报警时间间隔，防止刷屏; 0表示不去重
WARNING_LEVEL = "DEBUG"  # 报警级别， DEBUG / ERROR
WARNING_FAILED_COUNT = 10  # 任务失败数 超过WARNING_FAILED_COUNT则报警
#
